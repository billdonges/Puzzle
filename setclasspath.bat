...
set CLASSPATH=%CLASSPATH%;C:\opt\github\TheApp\WebContent\WEB-INF\lib\mongo-2.10.0.jar
set CLASSPATH=%CLASSPATH%;C:\opt\github\TheApp\WebContent\WEB-INF\lib\mysql-connector-java-5.1.22-bin.jar